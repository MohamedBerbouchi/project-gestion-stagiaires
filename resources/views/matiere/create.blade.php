                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre_heure_tp" class="form-control" value="{{old('nombre_heure_tp')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="coef" class="form-control" value="{{old('coef')}}">
                                    @error('coef')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre_heure_total" class="form-control" value="{{old('nombre_heure_total')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre_heure_th" class="form-control" value="{{old('nombre_heure_th')}}">
                                    @error('nombre_heure_total')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
